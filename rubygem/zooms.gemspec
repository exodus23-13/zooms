...
version = begin
            require File.expand_path('../lib/zooms/version', __FILE__)
            Zooms::VERSION
          rescue LoadError
            "0.0.0"
          end
...
Gem::Specification.new do |gem|
  ...
  gem.summary       = %q{Zooms is an intelligent preloader for ruby applications. It allows normal development tasks to be run in a fraction of a second.}
  gem.homepage      = "http://zooms.is"

  gem.files         = files
  gem.extensions    = ["ext/inotify-wrapper/extconf.rb"]
  gem.executables   = ['zooms']
  gem.test_files    = []
  gem.name          = "zooms"
